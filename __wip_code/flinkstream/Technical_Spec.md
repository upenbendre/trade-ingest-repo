I have an Apache Pulsar topic addressed as persistent://front-office/trades/trades.incoming.normal with 32 partitions. It will have JSON messages with trades in the following format
